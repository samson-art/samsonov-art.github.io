                    ...
                    <div class="bg-top-shadow">
                        <div class="main" style="background: #000;">
                           ...
                           <?php get_page_content(); ?>
                                ...
                                <div style="width:790px; height:485px; margin: 0 auto;">
					<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script><div style="overflow:hidden;height:500px;width:790px;"><div id="gmap_canvas" style="height:500px;width:790px;"></div><a class="google-map-code" href="http://www.map-embed.com" id="get-map-data">see post</a><style>#gmap_canvas img{max-width:none!important;background:none!important}</style><a class="google-map-data" href="http://www.addlikebutton.net" id="get-map-data">addlikebutton.net</a></div><script type="text/javascript"> function init_map(){var myOptions = {zoom:17,center:new google.maps.LatLng(45.70681247421421,11.647583291015621),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById("gmap_canvas"), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(45.70681247421421, 11.647583291015621)});infowindow = new google.maps.InfoWindow({content:"<b>Calzaturificio Dal Molin S.N.C. Di Dal Molin Ermenegildo &amp; C.</b><br/>Via Palazzon, 92 <br/>36064 Mason Vicentino" });google.maps.event.addListener(marker, "click", function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
                    </div>
