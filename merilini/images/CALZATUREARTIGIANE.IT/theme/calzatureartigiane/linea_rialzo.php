                            	...
                            	<div class="wrapper indent-bot">
                                    ...
                                    <div id="thumbs" class="navigation">
                                        <ul class="thumbs noscript" style="width:325px !important;">
                                            <li>
                                                <a class="thumb" href="<?php get_theme_url(); ?>/images/scarpa_rialzo1.jpg" title="Scarpa con rialzo interno"> <img src="<?php get_theme_url(); ?>/images/thumb-rialzo1.jpg" alt="Scarpa con rialzo interno" /><span></span> </a>
                                            </li> 
                                            <li>
                                                <a class="thumb" href="<?php get_theme_url(); ?>/images/scarpa_rialzo2.jpg" title="Scarpa con rialzo interno"> <img src="<?php get_theme_url(); ?>/images/thumb-rialzo2.jpg" alt="Scarpa con rialzo interno" /> <span></span></a>
                                            </li> 
                                            <li>
                                                <a class="thumb" href="<?php get_theme_url(); ?>/images/scarpa_rialzo3.jpg" title="Scarpa con rialzo interno"> <img src="<?php get_theme_url(); ?>/images/thumb-rialzo3.jpg" alt="Scarpa con rialzo interno" /> <span></span></a>
                                            </li> 
                                             <li>
                                                <a class="thumb" href="<?php get_theme_url(); ?>/images/scarpa_rialzo4.jpg" title="Scarpa con rialzo interno"> <img src="<?php get_theme_url(); ?>/images/thumb-rialzo4.jpg" alt="Scarpa con rialzo interno" /> <span></span></a>
                                            </li> 
