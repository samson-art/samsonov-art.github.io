                            	...
                            	<div class="wrapper indent-bot">
                                    ...
                                    <div id="thumbs" class="navigation">
                                        <ul class="thumbs noscript" style="width:325px !important;">
                                            <li>
                                                <a class="thumb" href="<?php get_theme_url(); ?>/images/scarpa_classica1.jpg" title="Scarpa classica"> <img src="<?php get_theme_url(); ?>/images/thumb-classica1.png" alt="Scarpa classica" /><span></span> </a>
                                            </li> 
                                            <li>
                                                <a class="thumb" href="<?php get_theme_url(); ?>/images/scarpa_classica2.jpg" title="Scarpa classica"> <img src="<?php get_theme_url(); ?>/images/thumb-classica2.png" alt="Scarpa classica" /> <span></span></a>
                                            </li> 
                                            <li>
                                                <a class="thumb" href="<?php get_theme_url(); ?>/images/scarpa_classica3.jpg" title="Scarpa classica"> <img src="<?php get_theme_url(); ?>/images/thumb-classica3.png" alt="Scarpa classica" /> <span></span></a>
                                            </li> 
                                             <li>
                                                <a class="thumb" href="<?php get_theme_url(); ?>/images/scarpa_classica4.jpg" title="Scarpa classica"> <img src="<?php get_theme_url(); ?>/images/thumb-classica4.png" alt="Scarpa classica" /> <span></span></a>
                                            </li> 
